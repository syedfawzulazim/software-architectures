...
public class UserPersistenceAdapter implements UserRepositoryPort {
    ...
    public User save(User user) {
        io.software_architectures.clean.user_service.adapter.out.persistence.UserJpaEntity entity = new io.software_architectures.clean.user_service.adapter.out.persistence.UserJpaEntity(user.getId(), user.getName(), user.getEmail());
